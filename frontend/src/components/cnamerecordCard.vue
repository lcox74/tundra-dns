...
import { CNAMERecord } from '../models/record';

export default {
    name: 'CNAMERecordCard',
    components: {
        FontAwesomeIcon,
    },
    props: {
    ...
    <div class="w-fill min-h-24 mx-5 mb-5 px-8 rounded-xl border-2 border-gray-200 hover:border-2 hover:border-solid hover:border-accent"
        ...
        <div class="flex w-full h-16 ">
            <div class="grid w-full grid-cols-10 font-mono my-auto">
                <div>
                    <p class="text-cname font-bold text-center text-2xl">CNAME</p>
                </div>
                ...
                <div class="flex justify-end col-span-4 ">
                    <p class="text-primary my-auto font-medium text-center">{{ record.getAlias() }}</p>
                </div>
            </div>
        </div>
